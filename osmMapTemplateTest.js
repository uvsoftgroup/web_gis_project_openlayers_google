...
function osmMapTemplateTest(){
  ...
  var addedlayers=[osm, stationLayer,linkLayer,coverAreaRadiusLayer,editablelayer];
  ...
  //add the feature
  linkLayer.addFeatures([stationLinkfeaure, stationLinkfeaureTest2]);
